...
import 'package:workwise_autism/screens/status/potential_autism/signup/profile_creation/full_name.dart';
...
class PotentialAutismSignup extends StatefulWidget {
  final int? status;

  PotentialAutismSignup({Key? key, this.status}) : super(key: key);

  @override
  _PotentialAutismSignupState createState() => _PotentialAutismSignupState();
}

class _PotentialAutismSignupState extends State<PotentialAutismSignup> {
  bool _isLoading = false;
